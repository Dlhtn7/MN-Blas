...
void transpose_f(float *matrice, int lignes, int colonnes, float *res) {
...
void transpose_f2(complexe_float_t *matrice, int lignes, int colonnes, complexe_float_t *res) {
...
void transpose_d(double *matrice, int lignes, int colonnes, double *res) {
...
void transpose_d2(complexe_double_t *matrice, int lignes, int colonnes, complexe_double_t *res) {
...
void transpose_comp_f(complexe_float_t *matrice, int lignes, int colonnes, complexe_float_t *res){
    complexe_float_t temp[lignes * colonnes];
...
void transpose_comp_d(complexe_double_t *matrice, int lignes, int colonnes, complexe_double_t *res){
    complexe_double_t temp[lignes * colonnes];
